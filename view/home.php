      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          ...
          <div class="carousel-caption d-none d-md-block text-white">
            <h5 style="text-shadow: 1px 1px 1px aqua;">Visi Sekolah</h5>
            <p style="text-shadow: 1px 1px 1px red;">Tetap Maju Walau Banyak Yang Sudah Mundur, Tetap Mundur Walau Sudah Banyak Yang Maju</p>
          </div>
        </div>
        <div class="carousel-item" data-bs-interval="2000">
          <img src="public/img/Misi.jpg" class="d-block w-100 object-fit-cover" alt="..." style="height: 700px;">
          <div class="carousel-caption d-none d-md-block text-white">
            <h5 style="text-shadow: 1px 1px 1px aqua;">Misi Sekolah</h5>
            <p style="text-shadow: 1px 1px 1px red;">Mencerdaskan, Membimbing Serta Membantu Antar Sesama Warga Sekolah</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="public/img/Harapan.jpg" class="d-block w-100 object-fit-cover" alt="..." style="height: 700px;">
          <div class="carousel-caption d-none d-md-block text-white">
            <h5 style="text-shadow: 1px 1px 1px aqua;">Harapan Sekolah</h5>
            <p style="text-shadow: 1px 1px 1px red;">Menjadikan Anak Berfikir Secara Logic Dan Menjadi Lulusan yang Mampu Berfikir Kritis</p>
          </div>
        </div>
      </div>
...
<div class="container rounded my-3">
  <div class="text-center">
    ...
    <div class="row my-2 align-items-center">
      ...
      <div class="font-monospace"><p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quis beatae fugiat exercitationem nihil voluptatum expedita praesentium pariatur eligendi placeat velit. Error, ut eveniet? Harum iusto officia ad aliquam saepe fugiat!</p>
      </div> 
      </div>
    </div>
    <div class="row my-2 align-items-center">
          ...
          <div class="col-6 bg-info-subtle p-5 rounded-3">
            <h2 class="h2 mb-5 mt-2 text-center">Contact</h2>
              <h5 class="h5"><i class="bi bi-house-door"></i>
                Alamat</h5>
                <p class="p">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126515.4428458862!2d110.2807799073777!3d-7.7251821830264795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5fe6f3858fef%3A0x68b4c276c78b244c!2sSTM%20Tadika%20Mesra!5e0!3m2!1sid!2sid!4v1723535326805!5m2!1sid!2sid" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> Jln.Hayam Wuruk Km 13, Sukabangga, Kecamatan Prokontra, Kabupaten Kidul Lepen, Provinsi Mabur Duwur, Indonesia</p>
          ...
          <div class="col-6 bg-warning-subtle rounded-3 p-5">
            ...
            <form>
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style="width: 50%;">
